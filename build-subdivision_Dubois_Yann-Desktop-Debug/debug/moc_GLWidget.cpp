...
#include "../../subdivision_Dubois_Yann/src/p3d/gui/GLWidget.h"
...
QT_MOC_LITERAL(1, 9, 13), // "updateRequest"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 10) // "updateData"

    },
    "GLWidget\0updateRequest\0\0updateData"
};
...
void GLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GLWidget::updateRequest)) {
                *result = 0;
                return;
            }
        }
