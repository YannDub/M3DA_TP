...
#include "../../subdivision_Dubois_Yann/src/application/GLApplication.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_GLApplication_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_GLApplication_t qt_meta_stringdata_GLApplication = {
    {
QT_MOC_LITERAL(0, 0, 13) // "GLApplication"
...
const QMetaObject GLApplication::staticMetaObject = {
    { &GLWidget::staticMetaObject, qt_meta_stringdata_GLApplication.data,
      qt_meta_data_GLApplication,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *GLApplication::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GLApplication.stringdata0))
